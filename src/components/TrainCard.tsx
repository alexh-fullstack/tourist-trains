      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div className="space-y-3">
          ...
          <div
            ...
            className="bg-gray-50 dark:bg-gray-800/70 border border-gray-100 dark:border-gray-750 rounded-lg p-3"
          >
            <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 flex items-center justify-between">
              <span>Маршрут тура:</span>
              <span className="text-gray-400 dark:text-gray-500 font-normal">{train.route.length} станций</span>
            </div>
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-700 dark:text-gray-300 bg-red-50/70 dark:bg-red-950/30 border border-red-100 dark:border-red-900/40 px-3 py-2 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-1 text-xs">
              <span className="text-gray-500 dark:text-gray-400">Ближайший выезд:</span>
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {train.tags.map((tag) => (
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-medium bg-gray-100 dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-950/50 hover:text-[#E21A1A] dark:hover:text-red-300 text-gray-600 dark:text-gray-300 px-2 py-0.5 rounded transition cursor-pointer"
                >
        ...
        <div className="pt-4 mt-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between gap-4">
          <div>
            <div className="text-[11px] text-gray-500 dark:text-gray-400 font-medium">Стоимость</div>
            <div className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white flex items-baseline gap-1">
              <span className="text-xs text-gray-500 dark:text-gray-400 font-normal">от</span>
