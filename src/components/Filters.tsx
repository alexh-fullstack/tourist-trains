...
export const Filters: React.FC<FiltersProps> = ({
  ...
  return (
    <section aria-label="Фильтры и поиск туров" className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-8">
      <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 sm:gap-4 items-center">
          ...
          <div className="relative md:col-span-8">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 sm:py-3 bg-gray-50 hover:bg-gray-100/70 focus:bg-white border border-gray-300 rounded-lg text-sm sm:text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E21A1A]/20 focus:border-[#E21A1A] transition duration-150"
            />
            {filters.searchQuery && (
              <button
                type="button"
          ...
          <div className="md:col-span-4 relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-8 py-2.5 sm:py-3 bg-gray-50 hover:bg-gray-100/70 focus:bg-white border border-gray-300 rounded-lg text-sm sm:text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#E21A1A]/20 focus:border-[#E21A1A] transition duration-150 cursor-pointer appearance-none"
            >
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-md text-xs sm:text-sm font-medium transition-all duration-150 cursor-pointer ${
                filters.selectedMonth === ''
                  ? 'bg-[#2B303A] text-white shadow-xs font-semibold'
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              Все месяцы
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-gray-100 text-xs sm:text-sm text-gray-600">
          <div className="flex items-center gap-2">
            <Filter className="w-4 h-4 text-gray-400" />
            <span>
              Показано маршрутов: <strong className="text-gray-900 font-semibold">{totalResults}</strong>
            </span>
          </div>
          ...
          {hasActiveFilters && (
            <button
              type="button"
              onClick={onReset}
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#E21A1A] hover:text-[#C81010] bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-md transition duration-150 cursor-pointer"
            >
