...
export const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header className="w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 transition-colors duration-200">
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 text-xs text-gray-700 dark:text-gray-300 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3 sm:gap-4 text-gray-700 dark:text-gray-300">
            <div className="hidden md:flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400 font-medium">
            ...
            <button
              type="button"
              className="hidden lg:flex items-center gap-1.5 hover:text-[#E21A1A] dark:hover:text-[#FF4D4D] transition cursor-pointer text-gray-600 dark:text-gray-400"
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-gray-200 dark:border-gray-700">
              {/* Language Selector */}
              <div className="flex items-center gap-0.5 text-gray-600 dark:text-gray-300 font-semibold cursor-pointer hover:text-[#E21A1A] dark:hover:text-[#FF4D4D] text-xs px-1 py-1 rounded">
                <span>RUS</span>
              ...
              <button
                ...
                className="flex items-center justify-center p-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-amber-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition cursor-pointer border border-gray-200 dark:border-gray-700"
              >
                {theme === 'dark' ? (
      ...
      {/* Navigation Sub-Bar */}
      <div className="bg-[#2B303A] dark:bg-gray-950 text-gray-200 text-xs font-medium hidden sm:block border-b border-transparent dark:border-gray-800 transition-colors duration-200">
